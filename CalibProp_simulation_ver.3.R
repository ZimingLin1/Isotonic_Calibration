...
sim_one_ATE_est_with_pi(K_times=50, n_samples=5000,  outcome_reg_type="xgboost", ps_est_type="xgboost", calibration_method="none")
sim_one_ATE_est_with_pi(K_times=50, n_samples=5000,  outcome_reg_type="xgboost", ps_est_type="xgboost", calibration_method="deterministic truncation")
sim_one_ATE_est_with_pi(K_times=50, n_samples=5000,  outcome_reg_type="xgboost", ps_est_type="xgboost", calibration_method="adaptive truncation")
sim_one_ATE_est_with_pi(K_times=50, n_samples=5000,  outcome_reg_type="xgboost", ps_est_type="xgboost", calibration_method="isotonic regression")
...
logit_evaluation_results2 <- sim_ATE_est_with_pi_n_varying(K_times=100, n_samples_range = my_sample_range2, overlap=1, outcome_reg_type="logit", ps_est_type="logit")
logit_plots <- make_plots_for_results(logit_evaluation_results2)
