...
my_sample_range2 <- c(1000, 2000, 3000, 4000, 5000, 8000, 10000, 15000)
xgbooost_evaluation_results2 <- sim_ATE_est_with_pi_n_varying(K_times=100, n_samples_range = my_sample_range2, overlap=1, outcome_reg_type="xgboost", ps_est_type="xgboost")
